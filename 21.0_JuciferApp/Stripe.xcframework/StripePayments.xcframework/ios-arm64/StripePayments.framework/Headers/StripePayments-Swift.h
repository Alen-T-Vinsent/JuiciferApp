...
///
- (void)collectBankAccountForPaymentWithClientSecret:(NSString * _Nonnull)clientSecret params:(STPCollectBankAccountParams * _Nonnull)params from:(UIViewController * _Nonnull)viewController completion:(void (^ _Nonnull)(STPPaymentIntent * _Nullable, NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,introduced=12);
/// Presents a modal from the viewController to collect bank account
/// and if completed successfully, link your bank account to a PaymentIntent
/// \param clientSecret Client secret of the payment intent
///
...
/// expanded <code>paymentMethod</code> containing detailed payment method information
///
- (void)collectBankAccountForPaymentWithClientSecret:(NSString * _Nonnull)clientSecret returnURL:(NSString * _Nullable)returnURL params:(STPCollectBankAccountParams * _Nonnull)params from:(UIViewController * _Nonnull)viewController completion:(void (^ _Nonnull)(STPPaymentIntent * _Nullable, NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,introduced=12);
/// Presents a modal from the viewController to collect bank account
...
/// expanded <code>paymentMethod</code> containing detailed payment method information
///
- (void)collectBankAccountForSetupWithClientSecret:(NSString * _Nonnull)clientSecret params:(STPCollectBankAccountParams * _Nonnull)params from:(UIViewController * _Nonnull)viewController completion:(void (^ _Nonnull)(STPSetupIntent * _Nullable, NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,introduced=12);
/// Presents a modal from the viewController to collect bank account
/// and if completed successfully, link your bank account to a SetupIntent
/// \param clientSecret Client secret of the setup intent
///
...
/// expanded <code>paymentMethod</code> containing detailed payment method information
///
- (void)collectBankAccountForSetupWithClientSecret:(NSString * _Nonnull)clientSecret returnURL:(NSString * _Nullable)returnURL params:(STPCollectBankAccountParams * _Nonnull)params from:(UIViewController * _Nonnull)viewController completion:(void (^ _Nonnull)(STPSetupIntent * _Nullable, NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,introduced=12);
@end
...
///
- (void)confirmSetupIntent:(STPSetupIntentConfirmParams * _Nonnull)setupIntentConfirmParams withAuthenticationContext:(id <STPAuthenticationContext> _Nonnull)authenticationContext completion:(void (^ _Nonnull)(enum STPPaymentHandlerActionStatus, STPSetupIntent * _Nullable, NSError * _Nullable))completion SWIFT_AVAILABILITY(maccatalyst_app_extension,unavailable) SWIFT_AVAILABILITY(ios_app_extension,unavailable);
...
/// \param completion The completion block. If the status returned is <code>STPPaymentHandlerActionStatusSucceeded</code>, the SetupIntent status will always be  STPSetupIntentStatusSucceeded.
///
- (void)handleNextActionForSetupIntent:(NSString * _Nonnull)setupIntentClientSecret withAuthenticationContext:(id <STPAuthenticationContext> _Nonnull)authenticationContext returnURL:(NSString * _Nullable)returnURL completion:(void (^ _Nonnull)(enum STPPaymentHandlerActionStatus, STPSetupIntent * _Nullable, NSError * _Nullable))completion SWIFT_AVAILABILITY(maccatalyst_app_extension,unavailable) SWIFT_AVAILABILITY(ios_app_extension,unavailable);
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// An unknown type.
  STPPaymentMethodTypeUnknown = 28,
};
...
SWIFT_CLASS("_TtC14StripePayments18STPRedirectContext") SWIFT_AVAILABILITY(maccatalyst_app_extension,unavailable) SWIFT_AVAILABILITY(ios_app_extension,unavailable)
