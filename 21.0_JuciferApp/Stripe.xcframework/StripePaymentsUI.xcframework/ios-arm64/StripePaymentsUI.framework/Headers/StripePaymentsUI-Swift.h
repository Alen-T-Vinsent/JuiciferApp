...
SWIFT_CLASS("_TtC16StripePaymentsUI30PersistablePaymentMethodOption")
@interface PersistablePaymentMethodOption : NSObject
...
SWIFT_PROTOCOL("_TtP16StripePaymentsUI33_stpspmsbeta_STPBackendAPIAdapter_")
@protocol _stpspmsbeta_STPBackendAPIAdapter <NSObject>
...
- (void)setSelectedPaymentMethodOptionWithPaymentOption:(PersistablePaymentMethodOption * _Nullable)paymentOption completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
/// Retrieve the last selected Payment Method Option for the customer
- (void)retrieveSelectedPaymentMethodOptionWithCompletion:(void (^ _Nonnull)(PersistablePaymentMethodOption * _Nullable, NSError * _Nullable))completion;
@end

@protocol _stpspmsbeta_STPCustomerEphemeralKeyProvider;
@class STPAPIClient;
...
SWIFT_CLASS("_TtC16StripePaymentsUI31_stpspmsbeta_STPCustomerContext")
@interface _stpspmsbeta_STPCustomerContext : NSObject <_stpspmsbeta_STPBackendAPIAdapter>
...
- (nonnull instancetype)initWithKeyProvider:(id <_stpspmsbeta_STPCustomerEphemeralKeyProvider> _Nonnull)keyProvider;
/// Initializes a new <code>STPCustomerContext</code> with the specified key provider.
/// Upon initialization, a CustomerContext will fetch a new ephemeral key from
/// your backend and use it to prefetch the customer object specified in the key.
/// Subsequent customer and payment method retrievals (e.g. by <code>STPPaymentContext</code>)
...
/// returns:
/// the newly-instantiated customer context.
- (nonnull instancetype)initWithKeyProvider:(id <_stpspmsbeta_STPCustomerEphemeralKeyProvider> _Nullable)keyProvider apiClient:(STPAPIClient * _Nonnull)apiClient;
...
SWIFT_PROTOCOL("_TtP16StripePaymentsUI44_stpspmsbeta_STPCustomerEphemeralKeyProvider_")
@protocol _stpspmsbeta_STPCustomerEphemeralKeyProvider <NSObject>
...
SWIFT_CLASS("_TtC16StripePaymentsUI28_stpspmsbeta_STPEphemeralKey")
@interface _stpspmsbeta_STPEphemeralKey : NSObject <STPAPIResponseDecodable>
...
SWIFT_CLASS("_TtC16StripePaymentsUI35_stpspmsbeta_STPEphemeralKeyManager")
@interface _stpspmsbeta_STPEphemeralKeyManager : NSObject
/// Initializes a new <code>STPEphemeralKeyManager</code> with the specified key provider.
...
///
/// returns:
/// the newly-initiated <code>STPEphemeralKeyManager</code>.
- (nonnull instancetype)initWithKeyProvider:(id _Nullable)keyProvider apiVersion:(NSString * _Nonnull)apiVersion performsEagerFetching:(BOOL)performsEagerFetching OBJC_DESIGNATED_INITIALIZER;
- (void)getOrCreateKey:(void (^ _Nonnull)(_stpspmsbeta_STPEphemeralKey * _Nullable, NSError * _Nullable))completion;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_PROTOCOL("_TtP16StripePaymentsUI36_stpspmsbeta_STPEphemeralKeyProvider_") SWIFT_DEPRECATED_MSG("use `STPCustomerEphemeralKeyProvider` or `STPIssuingCardEphemeralKeyProvider` depending on the type of key that will be fetched.")
@protocol _stpspmsbeta_STPEphemeralKeyProvider <_stpspmsbeta_STPCustomerEphemeralKeyProvider>
@end
...
/// It provides a way for Stripe utility classes to request a new ephemeral key from
/// your backend, which it will use to retrieve and update Stripe API objects.
SWIFT_PROTOCOL("_TtP16StripePaymentsUI47_stpspmsbeta_STPIssuingCardEphemeralKeyProvider_")
@protocol _stpspmsbeta_STPIssuingCardEphemeralKeyProvider <NSObject>
