                ...
                VStack(alignment:.leading){
                    ...
                    HStack{
                        ...
                        VStack{
                            ...
                            NavigationLink {
                                BuyView( isHomeActive: $isHomeActive)
                                    .onAppear{
                                        let buyModel = BuyItemModel(juiceId: juiceData.id, juiceQuantity: quantityTxt, juiceName: juiceData.name, juicePrice: juiceData.currentPrice)
                                        buyViewModel.updateProductInCart(itemModel: buyModel)
                                        buyViewModel.lastAddedJuiceId = juiceData.id
                                    }
                            } label: {
                                //buy now button redirects to buy instantly
                                HStack{
                                    Text("Buy Now")
                                }
                                .frame(maxWidth: .infinity)
